...
const WhatWeDo = () => {
  return (
    <div className="text-2xl mt-16 py-16 rounded-t-[3em] bg-[#0F110E] text-center font-apercu flex flex-col items-center justify-center">
      <span className="z-20 text-5xl tracking-tight">What We Do</span>
      <span className="z-20 px-10 mt-4 text-xl font-light">
      ...
      <div className="mt-12 min-h-[40%] w-[70%] rounded-2xl p-8 flex flex-col justify-center items-center bg-lime-600 bg-opacity-15 border-2 border-lime-800 border-opacity-25">
