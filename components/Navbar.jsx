...
const Navbar = () => {
  ...
  return (
    <nav className="bg-black w-full flex items-center font-apercu justify-center lg:justify-between h-24 px-12 xl:p-14 text-white">
      <div >
        <Link href="/" className="font-bold text-3xl flex justify-center items-center">
          <img
            src="/alephinnov-logo.png"
            alt="logo"
            className="w-20 mt-12 lg:mt-0 lg:w-[2.1em] object-cover"
          />
