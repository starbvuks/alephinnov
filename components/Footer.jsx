...
const Footer = () => {
  return (
    <div className="w-full z-20 h-40 xl:h-32 mt-16 py-7 xl:py-4 pl-12 pr-9 bg-black text-white grid grid-cols-2 lg:grid-cols-3 justify-center lg:justify-center items-center">
      ...
      <div className="flex flex-col justify-end text-xs ml-6 text-right font-apercu">
        <span className="text-sm font-light tracking-[0.16em] mb-4">
          CONTACT
        </span>
